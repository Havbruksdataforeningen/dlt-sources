...
- **Stack-neutral core.** The library depends on dlt and nothing else. Destination, orchestration, secrets management, and log routing are the consumer's choices — shown as runnable code in the package's `examples/`, not encoded in the library.
