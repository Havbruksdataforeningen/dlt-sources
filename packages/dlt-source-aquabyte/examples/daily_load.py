...
# Bind nothing. The first run starts at the initial_date/initial_time in config, every later
# run resumes from the cursor dlt stored, so a scheduler just calls this on a timer.
