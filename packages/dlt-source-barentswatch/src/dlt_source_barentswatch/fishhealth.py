"""dlt source for the BarentsWatch Fish Health API, one of the APIs this package reads.

Four of the endpoints in https://www.barentswatch.no/bwapi/openapi/fishhealth/openapi.json,
committed as `specs/fishhealth.json`. Resources are named after their endpoints and yield the
...
from dlt_source_barentswatch.weeks import WeekRange
